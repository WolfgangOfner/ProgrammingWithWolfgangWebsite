...
description: Azure Cosmos DB DocumentDB is a JSON document store NoSQL database, similar to MongoDB. JSON document stores are the fastest growing NoSQL solutions. The reason why it's growing so fast is that it doesn't require assembling or disassembling object hierarchies into a flat relational design.
---
